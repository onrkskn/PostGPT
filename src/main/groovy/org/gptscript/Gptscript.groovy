...
File propsFile = new File("/Users/skyworks/Desktop/GROOVY/GPTScript/config.properties")
...
//içerik oluşturma
String prompt = "1. dunya savasinda bilinmeyen olaylar hakkinda kisa bir 200 kelimelik bir olay olustur"
...
//options.addArguments("profile-directory=Profile 10")
    ...
    try {
        ...
        if (title.contains("Anasayfa / X") || title.contains("Log in to X")) {
